...
class DefaultEntityRevisionDeleteForm extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\study_entity\Entity\DefaultEntityInterface
   */
  protected $revision;
  ...
  public static function create(ContainerInterface $container) {
    ...
    return new static(
      $entity_manager->getStorage('default_entity'),
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    drupal_set_message(t('Revision from %revision-date of Default entity %title has been deleted.', ['%revision-date' => format_date($this->revision->getRevisionCreationTime()), '%title' => $this->revision->label()]));
